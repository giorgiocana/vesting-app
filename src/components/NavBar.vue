    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            ...
            <form class="d-flex">
                ...
                <div v-else-if="this.accounts.length == 0">
                    <button
                        class="btn btn-primary dropdown-toggle me-2"
                        type="button"
                        id="connectWalletBtn"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="connectWalletBtn">
                        ...
                        <li><button @click="handleConnectToWalletConnect" class="dropdown-item" type="button">WalletConnect</button></li>
                    </ul>
                </div>
                <div v-else-if="this.accounts.length != 0" class="dropdown">
                        <button
                            class="btn btn-primary dropdown-toggle me-2"
                            type="button"
                            id="connectWalletBtn"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="connectWalletBtn">
                            <li v-for="account in this.accounts" :key="account">
                                <button @click="handleSetAccount(account)" class="dropdown-item" type="button"> {{ truncate(account) }} </button>
                            </li>
                        </ul>
                </div>
