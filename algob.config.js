 ...
 */
 let accounts_testnet = mkAccounts([
  ...
  {
    name: "team_acc",
    addr: process.env.VUE_APP_ADDR_ACC1_TESTNET,
    mnemonic: process.env.VUE_APP_MNEMONIC_ACC1_TESTNET,
  },
  {
    name: "advisors_acc",
    addr: process.env.VUE_APP_ADDR_ACC2_TESTNET,
    mnemonic: process.env.VUE_APP_MNEMONIC_ACC2_TESTNET,
  },
  {
    name: "private_investors_acc",
    addr: process.env.VUE_APP_ADDR_ACC3_TESTNET,
    mnemonic: process.env.VUE_APP_MNEMONIC_ACC3_TESTNET,
  },
  {
    name: "company_member_acc",
    addr: process.env.VUE_APP_ADDR_ACC4_TESTNET,
    mnemonic: process.env.VUE_APP_MNEMONIC_ACC4_TESTNET,
  },
]);
